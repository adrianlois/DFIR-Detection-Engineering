...
- [🔍 Análisis forense y artefactos](#%EF%B8%8F-anlisis-forense-y-artefactos)
    ...
    - [▶️ Análisis Forense en contenedores Docker](#%EF%B8%8F-anlisis-forense-en-contenedores-docker)
    - [▶️ Análisis y artefactos de ShellBags](#%EF%B8%8F-anlisis-y-artefactos-de-shellbags)
    - [▶️ Thumbcache Viewer](#%EF%B8%8F-thumbcache-viewer)
    - [▶️ Forense Android: Evidencias de imágenes eliminadas y enviadas por WhatsApp](#%EF%B8%8F-forense-android-evidencias-de-imgenes-eliminadas-y-enviadas-por-whatsapp)
    - [▶️ Comprobar si un usuario ejecutó el comando "sudo"](#%EF%B8%8F-comprobar-si-un-usuario-ejecut-el-comando-sudo)
    - [▶️ Artefactos en dispositivos USB (Windows, Linux y MacOS)](#%EF%B8%8F-artefactos-en-dispositivos-usb-windows-linux-y-macos)
    - [▶️ Análisis Forense de logs en AnyDesk, Team Viewer y LogMeIn](#%EF%B8%8F-anlisis-forense-de-logs-en-anydesk-team-viewer-y-logmein)
    ...
    - [▶️ Asignación de IPs en equipos](#%EF%B8%8F-asignacin-de-ips-en-equipos)
    ...
    - [▶️ Persistencia: suplantación de procesos del sistema](#%EF%B8%8F-persistencia-suplantacin-de-procesos-del-sistema)
...
- [📓 Detección de técnicas de evasión en sistemas SIEM, SOC y Anti-Forense](#%EF%B8%8F-deteccin-de-tcnicas-de-evasin-en-sistemas-siem-soc-y-anti-forense)
    ...
    - [▶️ Otra técnica de ejecución de CMD o PowerShell](#%EF%B8%8F-otra-tcnica-de-ejecucin-de-cmd-o-powershell)
    ...
    - [▶️ Claves de registro de Windows donde se almacenan las contraseñas](#%EF%B8%8F-claves-de-registro-de-windows-donde-se-almacenan-las-contraseas)
    - [▶️ WDigest Authentication: Habilitado / Deshabilitado](#%EF%B8%8F-wdigest-authentication-habilitado--deshabilitado)
    - [▶️ Detectar si un sistema es una máquina virtual con PowerShell o WMIC](#%EF%B8%8F-detectar-si-un-sistema-es-una-mquina-virtual-con-powershell-o-wmic)
    - [▶️ Técnicas de ofuscación en la ejecucación de comandos en Windows](#%EF%B8%8F-tcnicas-de-ofuscacin-en-la-ejecucacin-de-comandos-en-windows)
    ...
    - [▶️ Detectar malware que se está ejecutando desde una carpeta que no permite su acceso por error de ubicación (tipo de flujo NTFS en directorios $INDEX_ALLOCATION)](#%EF%B8%8F-detectar-malware-que-se-est-ejecutando-desde-una-carpeta-que-no-permite-su-acceso-por-error-de-ubicacin-tipo-de-flujo-ntfs-en-directorios-index_allocation)
    - [▶️ Auditoría en el uso privilegiado de los siguientes comandos](#%EF%B8%8F-auditora-en-el-uso-privilegiado-de-los-siguientes-comandos)
    - [▶️ Deshabilitar Windows Defender para eludir la detección de AMSI en la ejecución de binarios maliciosos (renombrar MsMpEng.exe a través del registro ControlSet00X)](#%EF%B8%8F-deshabilitar-windows-defender-para-eludir-la-deteccin-de-amsi-en-la-ejecucin-de-binarios-maliciosos-renombrar-msmpengexe-a-travs-del-registro-controlset00x)
